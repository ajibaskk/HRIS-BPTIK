            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview <?php if (isset($manajemen_akun) || isset($manajemen_hari_libur)) echo 'menu-open'; ?>">
                            <a href="#" class="nav-link <?php if (isset($manajemen_akun) || isset($manajemen_hari_libur)) echo 'active'; ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('manajemen/manajemen_akun'); ?>" class="nav-link pl-4 <?php if (isset($manajemen_akun)) echo 'active'; ?>">
                                        <i class="nav-icon fas fa-users"></i>
                                        <p style="font-size: 16px;">Manajemen Akun</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('manajemen/manajemen_hari_libur'); ?>" class="nav-link pl-4 <?php if (isset($manajemen_hari_libur)) echo 'active'; ?>">
                                        <i class="nav-icon fas fa-calendar"></i>
                                        <p style="font-size: 14px;">Manajemen Hari Libur</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item has-treeview <?php if (isset($daftar_pegawai) || isset($cuti_pegawai) || isset($riwayat_dinas_luar)) echo 'menu-open'; ?>">
                            <a href="#" class="nav-link <?php if (isset($daftar_pegawai) || isset($cuti_pegawai) || isset($riwayat_dinas_luar)) echo 'active'; ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('kepegawaian/acc_cuti_pegawai'); ?>" class="nav-link pl-4 <?php if (isset($cuti_pegawai)) echo 'active'; ?>">
                                        <i class="nav-icon fas fa-bars"></i>
                                        <p style="font-size: 10px;">Pengajuan Cuti Non PNS</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('kepegawaian/riwayat_dinas_luar'); ?>" class="nav-link pl-4 <?php if (isset($riwayat_dinas_luar)) echo 'active'; ?>">
                                        <i class="nav-icon fas fa-file"></i>
                                        <p style="font-size: 14px;">Dinas Luar</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item has-treeview <?php if (isset($daftar_kehadiran) || isset($struktur_unit)) echo 'menu-open'; ?>">
                            <a href="#" class="nav-link <?php if (isset($daftar_kehadiran) || isset($struktur_unit)) echo 'active'; ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('kehadiran/daftar_kehadiran'); ?>" class="nav-link pl-4 <?php if (isset($daftar_kehadiran)) echo 'active'; ?>">
                                        <i class="nav-icon fas fa-bars"></i>
                                        <p style="font-size: 12px;">
                                            Daftar Kehadiran Non PNS
                                        </p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('kehadiran/struktur_unit'); ?>" class="nav-link pl-4 <?php if (isset($struktur_unit)) echo 'active'; ?>">
                                        <i class="nav-icon fas fa-sitemap"></i>
                                        <p style="font-size: 12px;">
                                            Struktur Unit Kehadiran
                                        </p>
                                    </a>
                                </li>
                            </ul>
