...
<div class="modal fade" id="modal-detail" tabindex="-1" role="dialog" aria-labelledby="Cuti" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cuti">Form Dinas Luar</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <p class="text-center" id="nama"></p>
                <p class="text-center" id="nip"></p>
                <hr>
                <div class="d-flex">
                    <pre>Unit Kerja     : </pre>
            ...
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
                <div class="modal-footer">
                    <button type="submit" class="btn btn-danger" value="" name="batal-cuti" id="batal-cuti" data-btn="batal" disabled>Batal</button>
                    <button type="submit" class="btn btn-danger" value="" name="tolak-cuti" id="tolak-cuti" data-btn="tolak">Tolak</button>
                    <button type="submit" class="btn btn-success" value="" name="setuju-cuti" id="setuju-cuti" data-btn="setuju">Setujui</button>
                    <input type="hidden" class="btn btn-success" value="" name="tanggal-cuti" id="tanggal-cuti"></input>
                </div>
            </form>
        </div>
    </div>
...
<div class="content-header row">
    <h1 class="text-dark ml-2 mr-2">Dinas Luar</h1>
</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="riwayat-dinas-luar-pegawai-table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center align-middle">Persetujuan</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">' . date("d/m/Y", strtotime($data['tanggal_cuti_akhir'])) . '</td>';
                                        if ($data['persetujuan'] == 0) {
                                            echo '<td class="text-center"><h5><span class="badge badge-warning">Belum Disetujui</span></td>';
                                        } else if ($data['persetujuan'] == 1) {
                                            echo '<td class="text-center"><h5><span class="badge badge-success">Disetujui</span></td>';
                                        } else {
                                            echo '<td class="text-center"><h5><span class="badge badge-danger">Ditolak</span></td>';
                                        }
