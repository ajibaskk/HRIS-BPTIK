...
<div class="content-header">
  <h1 class="text-dark ml-2">Persetujuan Cuti Pegawai Non-PNS</h1>
</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table id="acc-cuti-pegawai-table" class="table table-bordered table-hover">
              <thead>
                <tr>
                ...
                if ($data_table) {
                  foreach ($data_table as $data) {
                    ...
                    echo '
                              ...
                              <button type="button" class="btn btn-outline-primary detail-btn mx-2" data-id="' . $data['id_cuti_pegawai'] . '">Detail</button>
                              </td>
                            </tr>
                          ';
                  }
