  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?= base_url('kepegawaian/riwayat_cuti_pegawai') ?>" class="btn btn-success">Riwayat Cuti</a>
      </div>
    </div>
  </div>
</div>
...
<div class="content-header">
  <h1 class="text-dark ml-2">Permhonoan Cuti Alasan Penting</h1>
</div>
  ...
  <div class="container-fluid">
    ...
    <div class="card card-default">
      <div class="card-header">
        <h3 class="card-title">Form Permohonan Cuti Alasan Penting</h3>
      </div>
      <!-- /.card-header -->
      <div id="cuti-bersalin" class="card-body">
          ...
          <div class="col-md-12 px-5">
            ...
            <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" id="alasan" name="alasan" class="form-control" placeholder="Alasan Cuti" value="<?= set_value('alasan'); ?>">
                </div>
                <!-- /.input group -->
        ...
        <div class="text-right px-5">
          <input type="submit" class="btn btn-primary" id="submit-cuti" name="submit-cuti" data-btn="edit" value="Ajukan Cuti">
        </div>
        </form>
      </div>
    </div>
